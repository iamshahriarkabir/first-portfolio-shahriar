...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      review:
        "Shahriar is extremely talented. He delivered the project early and the code quality was top-notch.",
      stars: 5,
    },
    {
      id: 3,
  ...
  return (
    <section className="section py-20 px-4 bg-body dark:bg-darkBody transition-colors">
        ...
        >
          {testimonials.map((item) => (
            <SwiperSlide key={item.id} className="pb-10">
              <div className="bg-container dark:bg-darkContainer p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-card transition-all duration-300 relative group h-full select-none">
                {/* Quote Icon */}
