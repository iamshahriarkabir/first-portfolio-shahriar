        ...
        <div className="max-w-3xl mx-auto">
          ...
          {toggleState === 1 && (
            ...
            >
              ...
              <div className="text-right">
                <h3 className="font-semibold text-title">Senior Developer</h3>
                <span className="text-sm text-text block mb-2">Tech Solutions BD</span>
              ...
              <div>
                <h3 className="font-semibold text-title">Frontend Dev</h3>
                <span className="text-sm text-text block mb-2">Creative Agency</span>
                <div className="text-xs text-text flex items-center gap-1">
                   <Calendar size={14} /> 2021 - 2023
                </div>
              </div>

              {/* Exp Item 3 */}
              <div className="text-right">
                <h3 className="font-semibold text-title">Intern</h3>
                <span className="text-sm text-text block mb-2">Software Farm</span>
                <div className="text-xs text-text flex items-center justify-end gap-1">
          ...
          {toggleState === 2 && (
            ...
            >
              ...
              {/* Edu Item 1 */}
              <div className="text-right">
                <h3 className="font-semibold text-title">B.Sc in CSE</h3>
                <span className="text-sm text-text block mb-2">Dhaka University</span>
                <div className="text-xs text-text flex items-center justify-end gap-1">
              ...
              <div className="flex flex-col items-center">
                <span className="inline-block w-[13px] h-[13px] rounded-full bg-title"></span>
                <span className="block w-1px h-full bg-title translate-y-[-7px]"></span>
              </div>
              ...
              <div>
                <h3 className="font-semibold text-title">Web Design</h3>
                <span className="text-sm text-text block mb-2">Udemy Course</span>
                <div className="text-xs text-text flex items-center gap-1">
                   <Calendar size={14} /> 2021
                </div>
              </div>

              {/* Edu Item 3 */}
              <div className="text-right">
                <h3 className="font-semibold text-title">HSC Science</h3>
                <span className="text-sm text-text block mb-2">Dhaka College</span>
                <div className="text-xs text-text flex items-center justify-end gap-1">
                   <Calendar size={14} /> 2016 - 2018
                </div>
              </div>
